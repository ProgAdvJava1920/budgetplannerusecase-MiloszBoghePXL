...
CREATE TABLE IF NOT EXISTS `Payment` (
                                                         ...
                                                         `labelId` INT NULL,
                                                         PRIMARY KEY (`id`),
      #                                                 INDEX `fk_Payment_Account_idx` (`accountId` ASC) VISIBLE,
       #                                                  INDEX `fk_Payment_Counter_Account_idx` (`counterAccountId` ASC) VISIBLE,
        #                                                 INDEX `fk_Payment_Label1_idx` (`labelId` ASC) VISIBLE,
